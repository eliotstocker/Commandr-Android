 ...
 */
public class LightsOffCommand extends MostWantedCommand {

    private static String TITLE;
    private static String DEFAULT_PHRASE;
    private Context context;

    public LightsOffCommand(Context ctx) {
        DEFAULT_PHRASE = ctx.getString(R.string.lights_off_pharse);
        TITLE = ctx.getString(R.string.lights_off_title);
        context = ctx;
    }
